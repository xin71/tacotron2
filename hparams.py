...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        training_files='filelists/iemocap_vctk lj/train_filelist.txt',
        validation_files='filelists/iemocap_vctk lj/test_filelist.txt',
        validation_files_alt='filelists/iemocap_vctk lj/test_filelist_speaker.txt',
        validation_files_alt_emo='filelists/iemocap_vctk lj/test_filelist_emotion.txt',
